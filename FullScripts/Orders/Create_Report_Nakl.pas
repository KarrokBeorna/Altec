{
  * Скрипт позволяет печатать отчёт "Накладная на получение заказа" без захода в
  * меню "Отчёты". При этом проставляется статус "Отгружен" = 1.
  * Работает исключительно на последнем выделенном заказе
}
