{
  ...
  * печатать общую калькуляцию заказов по всем выделенным записям. Просто
  * подаём в отчёт вместо одного RecordID целый список из ID заказов.
  *
