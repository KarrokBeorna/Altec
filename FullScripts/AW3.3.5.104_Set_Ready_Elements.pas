const
  ...
  DELETE_STAGE_QUEUE = 'DELETE FROM FACTORY_UNITS_QUEUE WHERE STAGE = 3 AND UNITID IN (SELECT ID FROM FACTORY_UNITS WHERE PARENTUNITID = :ID)';
...
var
  ...
  S: IomSession;
  checkParts, checkOptimized, checkReserved: Boolean;
