const
  ...
  SET_STATUS2 = 'INSERT INTO ORDERSTATUSBANK (ORDERID, ORDERSTATUSID, MARK, DONE) VALUES           ' + #13#10 +
                '(:ORDERID, (SELECT FIRST 1 ID FROM ORDERSTATUSES WHERE NAME = ''Отгружен''), 0, 1)';
